...
public class MinIOUtils {
    ...
    public MinIOUtils(String endpoint, String bucketName, String
            accessKey, String secretKey, Integer imgSize, Integer fileSize) {
    ...
    public void createMinioClient() {
        try {
            if (null == minioClient) {
                ...
                Logger.info("创建完毕 MinioClient...");
            }
        } catch (Exception e) {
            Logger.error("[Minio工具类]>>>> MinIO服务器异常："+ e.getMessage());
        }
    }
    ...
    public static boolean isObjectExist(String bucketName, String objectName) {
        ...
        try {
            ...
            Logger.error("[Minio工具类]>>>> 判断文件是否存在, 异常："+ e.getMessage());
            exist = false;
        }
        return exist;
    }
    ...
    public static boolean isFolderExist(String bucketName, String objectName) {
        ...
        try {
            ...
            Logger.error("[Minio工具类]>>>> 判断文件夹是否存在，异常："+ e.getMessage());
            exist = false;
        }
        return exist;
    }
    ...
    public static void removeFiles(String bucketName, List<String> keys) {
        ...
        keys.forEach(s -> {
            ...
            try {
                ...
                Logger.error("[Minio工具类]>>>> 批量删除文件，异常："+ e.getMessage());
            }
        });
    }
